                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-right text-xs font-bold hidden sm:block">
                          {(() => {
                            const activeCount = bayMachines.filter((m) =>
                              activeTab === 'MASTER'
                                ? (m.status || 'AKTIF') === 'AKTIF'
                                : getMachineStatusForShift(m, currentActiveShift) === 'AKTIF'
                            ).length;
                            const nonActiveCount = bayMachines.length - activeCount;
                            return (
                              <>
