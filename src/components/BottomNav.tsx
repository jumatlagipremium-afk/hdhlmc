...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onChangeTab }) => {
  ...
  return (
    <nav
      ...
      id="bottom-nav-bar"
    >
      <div className="max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto pointer-events-auto bg-white/95 backdrop-blur-xl border border-slate-300 rounded-3xl shadow-soft-lg px-2 py-1.5 flex items-center justify-around gap-1">
        {visibleTabs.map((tab) => {
          const Icon = tab.icon;
