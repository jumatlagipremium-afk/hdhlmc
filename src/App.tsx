...
import { SheetsSyncIndicator } from './components/SheetsSyncIndicator';
...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col antialiased">
      ...
      {/* Main Content Area */}
      <main className="flex-1 w-full max-w-[1720px] 2xl:max-w-[1920px] mx-auto px-3 sm:px-6 lg:px-8 py-2 sm:py-4">
      ...
      {/* Floating Google Sheets Real-time Auto-Sync Status Bar & Manual Fallback */}
      <SheetsSyncIndicator onOpenSettings={() => setActiveTab('reports')} />
